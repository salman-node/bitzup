...
const Create_Universal_Data = function (database_table_name, obJdata) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield db_connection_1.default.query(sql, abvalue);
            return result;
        }
        catch (err) {
            console.log(err);
...
const Get_All_Universal_Data = function (data, database_table_name) {
    return __awaiter(this, void 0, void 0, function* () {
...
const Get_Where_Universal_Data = function (data, database_table_name, filterquery) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield new Promise((resolve) => {
            ...
            db_connection_1.default.query(sql, abvalue, (err, result) => {
                if (err)
                    throw err;
                resolve(result);
            });
...
const Update_Universal_Data = function (database_table_name, updatedata, filterquery) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield new Promise((resolve) => {
            ...
            db_connection_1.default.connect((err) => {
                if (err)
                    throw err;
                const sql = `UPDATE ${database_table_name} SET ${abkeydata} WHERE ${filterkeydata}`;
                db_connection_1.default.query(sql, values, (err, result) => {
                    if (err)
                        throw err;
