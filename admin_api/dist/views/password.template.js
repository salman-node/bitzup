...
exports.passwordTemplate = void 0;
const dotenv = require('dotenv');
;
dotenv.config();
const passwordTemplate = (to_email, password, client_info) => {
    const passTemplate = `<html lang='en'>
<head>
  <meta charset='UTF-8' />
...
<body style='margin: 0px'>
  <div style='width: 100%; text-align: center; padding-top: 50px'>
    <img src='${process.env.ICON_URL}/images/logo.png' />
  </div>
...
exports.passwordTemplate = passwordTemplate;
//# sourceMappingURL=password.template.js.map