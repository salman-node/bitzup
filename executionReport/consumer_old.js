...
const consumeMessages = async () => {
  await consumer.run({
    eachMessage: async ({ topic, message }) => {
      ...
      if (topic === "execution-report-dbupdate") {
        ...
        if (count == 0) {
          ...
          if (data.X === "NEW") {
            ...
            if (data.S === "SELL") {
             const updateBalance = await updateOrInsertBalances({
              ...
              console.log("NEW SELL ",updateBalance)
            }
          }
          if (data.X === "PARTIALLY_FILLED") {
            ...
            if (data.S === "SELL") {
              ...
              console.log("SELL PARTIALLY FILLED ",updatedQuery)
            }
          }
          if (data.X === "TRADE") {
          ...
          if (data.X === "FILLED") {
            ...
            console.log("SELL FILLED ",result)
            }
          }
          if (data.X === "CANCELED") {
